    ...
    <div style={{ width: '100vw', height: '100vh', background: darkMode ? '#080a0f' : '#f0f4f8', display: 'flex', flexDirection: 'column', overflow: 'hidden', fontFamily: font, transition: 'background 0.3s' }}>
      ...
      <div style={{ flex: 1, overflow: 'hidden', display: 'flex' }}>
        ...
        {tab === 'journal' && (()=>{
          ...
          const hrSorted = [...hrEntries].sort((a,b)=>b.p-a.p)
          const topHr = hrSorted[0]
          const botHr = hrSorted[hrSorted.length-1]
          ...
          const analyzePatterns=async()=>{
            ...
            try{
              ...
              const prompt='Analyze this SPX trader. 4 brutally honest insights. Win:'+winPct+'% PnL:$'+Math.round(netPnl)+' AvgW:$'+Math.round(avgW)+' AvgL:$'+Math.round(avgL)+' PF:'+pf.toFixed(2)+'x DayWin:'+dayWpct+'% Playbooks:'+pbStr+' Hours:'+hrStr
              ...
              const txt2=dat.content?.[0]?.text||'No analysis'
              ...
              {allT.length===0?(
                ...
                <div>
                  ...
                  <div style={{background:'#0d1018',border:'1px solid '+C.tealBorder,borderRadius:10,padding:16}}>
                    ...
                    <div style={{fontSize:11,color:C.textDim,lineHeight:1.6}}>Your full trade history, hourly patterns, playbook performance, and day stats feed the AI companion.</div>
                  </div>
                </div>
              )}
            </div>
